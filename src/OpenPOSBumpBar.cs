...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.BumpBar, "OpenPOS 1.16 BumpBar", "OPOS BumpBar CCO Interop", 1, 16)]
    public class OpenPOSBumpBar : BumpBar, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSBumpBar  Specific Methods
        ...
        #endregion OPOSBumpBar  Specific Methods
    }
}