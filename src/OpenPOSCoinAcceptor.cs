...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.CoinAcceptor, "OpenPOS 1.16 CoinAcceptor", "OPOS CoinAcceptor CCO Interop", 1, 16)]
    public class OpenPOSCoinAcceptor : CoinAcceptor, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSCoinAcceptor  Specific Methods
        ...
        #endregion OPOSCoinAcceptor  Specific Methods
    }
}