...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.FiscalPrinter, "OpenPOS 1.16 FiscalPrinter", "OPOS FiscalPrinter CCO Interop", 1, 16)]
    public class OpenPOSFiscalPrinter : FiscalPrinter, IFiscalPrinter115, ILegacyControlObject, IDisposable
    {
        ...
        #region FiscalPrinter Specific Methods
        ...
        #endregion FiscalPrinter Specific Methods
    }
}