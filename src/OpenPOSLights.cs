...
namespace OpenPOS.CCO116Interop
{
    ...
    public class OpenPOSLights : Lights, ILights116, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSLights 1.16 Specific Properties

        public LightPatterns CapPattern
        {
            get { return (LightPatterns)InteropEnum<LightPatterns>.ToEnumFromInteger(_cco.CapPattern); }
        }

        #endregion OPOSLights 1.16 Specific Properties

        #region OPOSLights  Specific Methods
        ...
        #endregion OPOSLights  Specific Methods

        #region OPOSLights 1.16 Specific Methods

        public void SwitchOnPattern(LightPatterns pattern, LightAlarms alarm)
        {
            VerifyResult(_cco.SwitchOnPattern((int)pattern, (int)alarm));
        }

        public void SwitchOffPattern()
        {
            VerifyResult(_cco.SwitchOffPattern());
        }

        public void SwitchOnMultiple(IEnumerable<int> lightNumbers, int blinkOnCycle, int blinkOffCycle, LightColors color, LightAlarms alarm)
        {
            VerifyResult(_cco.SwitchOnMultiple(string.Join(",", lightNumbers), blinkOnCycle, blinkOffCycle, (int)color, (int)alarm));
        }

        #endregion OPOSLights 1.16 Specific Methods
    }
}