...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.SmartCardRW, "OpenPOS 1.16 SmartCardRW", "OPOS SmartCardRW CCO Interop", 1, 16)]
    public class OpenPOSSmartCardRW : SmartCardRW, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSSmartCardRW  Specific Methods
        ...
        #endregion OPOSSmartCardRW  Specific Methods
    }
}