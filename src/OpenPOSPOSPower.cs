...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.PosPower, "OpenPOS 1.16 POSPower", "OPOS POSPower CCO Interop", 1, 16)]
    public class OpenPOSPOSPower : PosPower, IPosPower116, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSPOSPower 1.16 Specific Properties

        public int BatteryCapacityRemainingInSeconds
        {
            get { return _cco.BatteryCapacityRemainingInSeconds; }
        }
        ...
        public int BatteryCriticallyLowThresholdInSeconds
        {
            get
            {
                return _cco.BatteryCriticallyLowThresholdInSeconds;
            }
            set
            {
                _cco.BatteryCriticallyLowThresholdInSeconds = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public int BatteryLowThresholdInSeconds
        {
            get
            {
                return _cco.BatteryLowThresholdInSeconds;
            }
            set
            {
                _cco.BatteryLowThresholdInSeconds = value;
                VerifyResult(_cco.ResultCode);
            }
        }

        public bool CapBatteryCapacityRemainingInSeconds
        {
            get { return _cco.CapBatteryCapacityRemainingInSeconds; }
        }

        public bool CapChargeTime
        {
            get { return _cco.CapChargeTime; }
        }

        public bool CapVariableBatteryCriticallyLowThresholdInSeconds
        {
            get { return _cco.CapVariableBatteryCriticallyLowThresholdInSeconds; }
        }

        public bool CapVariableBatteryLowThresholdInSeconds
        {
            get { return _cco.CapVariableBatteryLowThreshold; }
        }
        ...
        {
            get { return _cco.ChargeTime; }
        }

        #endregion OPOSPOSPower 1.16 Specific Properties

        #region OPOSPOSPower  Specific Methods
        ...
        #endregion OPOSPOSPower  Specific Methods
    }
}