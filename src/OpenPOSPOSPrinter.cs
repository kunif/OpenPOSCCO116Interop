...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.PosPrinter, "OpenPOS 1.16 POSPrinter", "OPOS POSPrinter CCO Interop", 1, 16)]
    public class OpenPOSPOSPrinter : PosPrinter, ILegacyControlObject, IDisposable
    {
        ...
        #region POSPrinter Specific Methods
        ...
        #endregion POSPrinter Specific Methods
    }
}