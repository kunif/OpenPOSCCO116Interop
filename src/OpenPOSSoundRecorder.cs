...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.RFIDScanner, "OpenPOS 1.16 SoundRecorder", "OPOS SoundRecorder CCO Interop", 1, 16)]
    public class OpenPOSSoundRecorder : RFIDScanner, ISoundRecorder116, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSSoundRecorder _cco = null;
        private const string _oposDeviceClass = "SoundRecorder";
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposedValue)
            {
                ...
                if (_cco != null)
                {
                    _cco.DataEvent -= (_IOPOSSoundRecorderEvents_DataEventEventHandler)_cco_DataEvent;
                    _cco.DirectIOEvent -= (_IOPOSSoundRecorderEvents_DirectIOEventEventHandler)_cco_DirectIOEvent;
                    _cco.ErrorEvent -= (_IOPOSSoundRecorderEvents_ErrorEventEventHandler)_cco_ErrorEvent;
                    //_cco.OutputCompleteEvent -= (_IOPOSSoundRecorderEvents_OutputCompleteEventEventHandler)_cco_OutputCompleteEvent;
                    _cco.StatusUpdateEvent -= (_IOPOSSoundRecorderEvents_StatusUpdateEventEventHandler)_cco_StatusUpdateEvent;
                    _cco = null;
                }
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSSoundRecorder();

                    // Register event handler
                    _cco.DataEvent += new _IOPOSSoundRecorderEvents_DataEventEventHandler(_cco_DataEvent);
                    _cco.DirectIOEvent += new _IOPOSSoundRecorderEvents_DirectIOEventEventHandler(_cco_DirectIOEvent);
                    _cco.ErrorEvent += new _IOPOSSoundRecorderEvents_ErrorEventEventHandler(_cco_ErrorEvent);
                    //_cco.OutputCompleteEvent += new _IOPOSSoundRecorderEvents_OutputCompleteEventEventHandler(_cco_OutputCompleteEvent);
                    _cco.StatusUpdateEvent += new _IOPOSSoundRecorderEvents_StatusUpdateEventEventHandler(_cco_StatusUpdateEvent);
                }
                catch
                {
        ...
        #region OPOSSoundRecorder  Specific Properties
        ...
        public bool CapChannel
        {
            get { return _cco.CapChannel; }
        }

        public bool CapRecordingLevel
        {
            get { return _cco.CapRecordingLevel; }
        }

        public bool CapSamplingRate
        {
            get { return _cco.CapSamplingRate; }
        }

        public bool CapSoundType
        {
            get { return _cco.CapSoundType; }
        }
        ...
        {
            get { return _cco.ChannelList.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries); }
        }
        ...
        public int RecordingLevel
        {
            get
            {
                return _cco.RecordingLevel;
            }
            set
            {
                _cco.RecordingLevel = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public string SamplingRate
        {
            get
            {
                return _cco.SamplingRate;
            }
            set
            {
                _cco.SamplingRate = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        {
            get { return _cco.SamplingRateList.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries); }
        }
        ...
        public byte[] SoundData
        {
            get
            {
                return InteropCommon.ToByteArrayFromString(_cco.SoundData, _binaryConversion);
            }
        }
        ...
        public string SoundType
        {
            get
            {
                return _cco.SoundType;
            }
            set
            {
                _cco.SoundType = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        {
            get { return _cco.SoundTypeList.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries); }
        }
        ...
        #endregion OPOSSoundRecorder  Specific Properties
        ...
        #region OPOSSoundRecorder  Specific Methods

        public void StartRecording(string fileName, bool overWrite, int recordingTime)
        {
            VerifyResult(_cco.StartRecording(fileName, overWrite, recordingTime));
        }

        public void StopRecording()
        {
            VerifyResult(_cco.StopRecording());
        }

        #endregion OPOSSoundRecorder  Specific Methods
    }
}