...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.LineDisplay, "OpenPOS 1.16 LineDisplay", "OPOS LineDisplay CCO Interop", 1, 16)]
    public class OpenPOSLineDisplay : LineDisplay, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSLineDisplay  Specific Methods
        ...
        #endregion OPOSLineDisplay  Specific Methods
    }
}