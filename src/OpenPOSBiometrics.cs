...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.Biometrics, "OpenPOS 1.16 Biometrics", "OPOS Biometrics CCO Interop", 1, 16)]
    public class OpenPOSBiometrics : Biometrics, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSBiometrics  Specific Methods
        ...
        #endregion OPOSBiometrics  Specific Methods
    }
}