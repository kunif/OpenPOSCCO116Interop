...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.ImageScanner, "OpenPOS 1.16 VideoCapture", "OPOS VideoCapture CCO Interop", 1, 16)]
    public class OpenPOSVideoCapture : ImageScanner, IVideoCapture116, ILegacyControlObject, IDisposable
    {
        private OpenPOS.Devices.OPOSVideoCapture _cco = null;
        private const string _oposDeviceClass = "VideoCapture";
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!_disposedValue)
            {
                ...
                if (_cco != null)
                {
                    ...
                    _cco.DirectIOEvent -= (_IOPOSVideoCaptureEvents_DirectIOEventEventHandler)_cco_DirectIOEvent;
                    _cco.ErrorEvent -= (_IOPOSVideoCaptureEvents_ErrorEventEventHandler)_cco_ErrorEvent;
                    _cco.StatusUpdateEvent -= (_IOPOSVideoCaptureEvents_StatusUpdateEventEventHandler)_cco_StatusUpdateEvent;
                    _cco = null;
                }
        ...
        public override void Open()
        {
            ...
            if (_cco == null)
            {
                try
                {
                    ...
                    _cco = new OpenPOS.Devices.OPOSVideoCapture();

                    // Register event handler
                    //_cco.DataEvent += new _IOPOSImageScannerEvents_DataEventEventHandler(_cco_DataEvent);
                    _cco.DirectIOEvent += new _IOPOSVideoCaptureEvents_DirectIOEventEventHandler(_cco_DirectIOEvent);
                    _cco.ErrorEvent += new _IOPOSVideoCaptureEvents_ErrorEventEventHandler(_cco_ErrorEvent);
                    _cco.StatusUpdateEvent += new _IOPOSVideoCaptureEvents_StatusUpdateEventEventHandler(_cco_StatusUpdateEvent);
                }
                catch
                {
        ...
        #region OPOSVideoCapture  Specific Properties

        public bool AutoExposure
        {
            get
            {
                return _cco.AutoExposure;
            }
            set
            {
                _cco.AutoExposure = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        public bool AutoFocus
        {
            get
            {
                return _cco.AutoFocus;
            }
            set
            {
                _cco.AutoFocus = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public bool AutoWhiteBalance
        {
            get
            {
                return _cco.AutoWhiteBalance;
            }
            set
            {
                _cco.AutoWhiteBalance = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public bool CapAutoExposure
        {
            get { return _cco.CapAutoExposure; }
        }

        public bool CapAutoFocus
        {
            get { return _cco.CapAutoFocus; }
        }

        public bool CapAutoGain
        {
            get { return _cco.CapAutoGain; }
        }

        public bool CapAutoWhiteBalance
        {
            get { return _cco.CapAutoWhiteBalance; }
        }
        ...
        public bool CapContrast
        {
            get { return _cco.CapContrast; }
        }

        public bool CapExposure
        {
            get { return _cco.CapExposure; }
        }

        public bool CapGain
        {
            get { return _cco.CapGain; }
        }

        public bool CapHorizontalFlip
        {
            get { return _cco.CapHorizontalFlip; }
        }

        public bool CapHue
        {
            get { return _cco.CapHue; }
        }

        public bool CapPhoto
        {
            get { return _cco.CapPhoto; }
        }

        public bool CapPhotoColorSpace
        {
            get { return _cco.CapPhotoColorSpace; }
        }

        public bool CapPhotoFrameRate
        {
            get { return _cco.CapPhotoFrameRate; }
        }

        public bool CapPhotoResolution
        {
            get { return _cco.CapPhotoResolution; }
        }

        public bool CapPhotoType
        {
            get { return _cco.CapPhotoType; }
        }

        public bool CapSaturation
        {
            get { return _cco.CapSaturation; }
        }
        ...
        public bool CapVerticalFlip
        {
            get { return _cco.CapVerticalFlip; }
        }

        public bool CapVideo
        {
            get { return _cco.CapVideo; }
        }

        public bool CapVideoColorSpace
        {
            get { return _cco.CapVideoColorSpace; }
        }

        public bool CapVideoFrameRate
        {
            get { return _cco.CapVideoFrameRate; }
        }

        public bool CapVideoResolution
        {
            get { return _cco.CapVideoResolution; }
        }
        ...
        public bool HorizontalFlip
        {
            get
            {
                return _cco.HorizontalFlip;
            }
            set
            {
                _cco.HorizontalFlip = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        public int Hue
        ...
        public string PhotoColorSpace
        {
            get
            {
                return _cco.PhotoColorSpace;
            }
            set
            {
                _cco.PhotoColorSpace = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        {
            get { return _cco.PhotoColorSpaceList.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries); }
        }

        public int PhotoFrameRate
        {
            get
            {
                return _cco.PhotoFrameRate;
            }
            set
            {
                _cco.PhotoFrameRate = value;
                VerifyResult(_cco.ResultCode);
            }
        }

        public int PhotoMaxFrameRate
        {
            get { return _cco.PhotoMaxFrameRate; }
        }
        ...
        public string PhotoResolution
        {
            get
            {
                return _cco.PhotoResolution;
            }
            set
            {
                _cco.PhotoResolution = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        {
            get { return _cco.PhotoResolutionList.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries); }
        }
        ...
        public string PhotoType
        {
            get
            {
                return _cco.PhotoType;
            }
            set
            {
                _cco.PhotoType = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        {
            get { return _cco.PhotoTypeList.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries); }
        }

        public int RemainingRecordingTimeInSec
        {
            get { return _cco.RemainingRecordingTimeInSec; }
        }
        ...
        public int Saturation
        {
            get
            {
                return _cco.Saturation;
            }
            set
            {
                _cco.Saturation = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public bool VerticalFlip
        {
            get
            {
                return _cco.VerticalFlip;
            }
            set
            {
                _cco.VerticalFlip = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        public VideoCaptureModeType VideoCaptureMode
        {
            get
            {
                return (VideoCaptureModeType)InteropEnum<VideoCaptureModeType>.ToEnumFromInteger(_cco.VideoCaptureMode);
            }
            set
            {
                _cco.VideoCaptureMode = (int)value;
                VerifyResult(_cco.ResultCode);
            }
        }
        public string VideoColorSpace
        {
            get
            {
                return _cco.VideoColorSpace;
            }
            set
            {
                _cco.VideoColorSpace = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        public int VideoFrameRate
        {
            get
            {
                return _cco.VideoFrameRate;
            }
            set
            {
                _cco.VideoFrameRate = value;
                VerifyResult(_cco.ResultCode);
            }
        }

        public int VideoMaxFrameRate
        {
            get { return _cco.VideoMaxFrameRate; }
        }
        ...
        public string VideoResolution
        {
            get
            {
                return _cco.VideoResolution;
            }
            set
            {
                _cco.VideoResolution = value;
                VerifyResult(_cco.ResultCode);
            }
        }
        ...
        {
            get { return _cco.VideoResolutionList.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries); }
        }
        ...
        #endregion OPOSVideoCapture  Specific Properties

        #region OPOSImageScanner  Specific Methods
        ...
        #endregion OPOSImageScanner  Specific Methods

        #region OPOSVideoCapture  Specific Methods

        public void StartVideo(string fileName, bool overWrite, int recordingTime)
        {
            VerifyResult(_cco.StartVideo(fileName, overWrite, recordingTime));
        }
        ...
        public void TakePhoto(string fileName, bool overWrite, int timeout)
        {
            VerifyResult(_cco.TakePhoto(fileName, overWrite, timeout));
        }

        #endregion OPOSVideoCapture  Specific Methods
    }
}