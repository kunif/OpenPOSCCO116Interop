...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.PinPad, "OpenPOS 1.16 PINPad", "OPOS PINPad CCO Interop", 1, 16)]
    public class OpenPOSPINPad : PinPad, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSPINPad  Specific Methods
        ...
        #endregion OPOSPINPad  Specific Methods
    }
}