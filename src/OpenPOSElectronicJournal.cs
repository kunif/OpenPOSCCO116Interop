...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.ElectronicJournal, "OpenPOS 1.16 ElectronicJournal", "OPOS ElectronicJournal CCO Interop", 1, 16)]
    public class OpenPOSElectronicJournal : ElectronicJournal, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSElectronicJournal  Specific Methods
        ...
        #endregion OPOSElectronicJournal  Specific Methods
    }
}