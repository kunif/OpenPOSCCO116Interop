...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.Keylock, "OpenPOS 1.16 Keylock", "OPOS Keylock CCO Interop", 1, 16)]
    public class OpenPOSKeylock : Keylock, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSKeylock  Specific Methods
        ...
        #endregion OPOSKeylock  Specific Methods
    }
}