...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.CheckScanner, "OpenPOS 1.16 CheckScanner", "OPOS CheckScanner CCO Interop", 1, 16)]
    public class OpenPOSCheckScanner : CheckScanner, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSCheckScanner  Specific Methods
        ...
        #endregion OPOSCheckScanner  Specific Methods
    }
}