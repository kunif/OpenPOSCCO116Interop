...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.SignatureCapture, "OpenPOS 1.16 SignatureCapture", "OPOS SignatureCapture CCO Interop", 1, 16)]
    public class OpenPOSSignatureCapture : SignatureCapture, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSSignatureCapture  Specific Methods
        ...
        #endregion OPOSSignatureCapture  Specific Methods
    }
}