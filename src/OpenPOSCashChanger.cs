...
namespace OpenPOS.CCO116Interop
{
    ...
    [ServiceObject(DeviceType.CashChanger, "OpenPOS 1.16 CashChanger", "OPOS CashChanger CCO Interop", 1, 16)]
    public class OpenPOSCashChanger : CashChanger, ILegacyControlObject, IDisposable
    {
        ...
        #region OPOSCashChanger  Specific Methods
        ...
        #endregion OPOSCashChanger  Specific Methods
    }
}